...
class StravaSummarySyncSchedulerUnitTest {
    ...
    void enqueueScheduledSummarySyncJobs_only_enqueues_permission_ready_links() {
        ...
        ArgumentCaptor<com.sudolife.application.service.strava.EnqueueStravaSummarySyncCommand> captor =
                ArgumentCaptor.forClass(com.sudolife.application.service.strava.EnqueueStravaSummarySyncCommand.class);
