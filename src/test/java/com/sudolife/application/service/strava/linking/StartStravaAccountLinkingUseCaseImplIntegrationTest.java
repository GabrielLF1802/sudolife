...
class StartStravaAccountLinkingUseCaseImplIntegrationTest {
    ...
    private static final String LINKING_SCOPE = "read,activity:read,profile:read_all";
    private static final String AUTHORIZATION_URL = "https://www.strava.com/oauth/authorize?scope=" + LINKING_SCOPE;
    ...
    void execute_persists_state_and_returns_provider_authorization_url_without_linking_account() {
        ...
        assertThat(oAuthProvider.lastRequest().scope()).isEqualTo(LINKING_SCOPE);
