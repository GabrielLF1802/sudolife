# Implementation Task Summary for Strava Account Linking
...
- [ ] 7.0 Add Strava REST endpoints, callback redirects, and security rules
- [ ] 8.0 Add end-to-end integration coverage and observability checks
